        ...
        <div class="row-fluid">
            ...
            <div class="block">
                ...
                <div class="block-content collapse in">
                    <div class="span12">
                        <!-- BEGIN FORM-->
                        <form action="/Admin/CTSanPham" id="form_sample_1" class="form-horizontal"
                              style="width:70%;margin:0 auto;" method="get">
                            <div class="control-group">
                                <label class="control-label">Danh mục<span class="required">*</span></label>
                                <div class="controls">
                                    <input disabled name="name" id="txt-ma-danh-muc" type="text" class="span6 m-wrap"
                                           style="width:500px !important;" value="${sanPham.maDanhMuc}"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Mã sản phẩm<span class="required">*</span></label>
                                <div class="controls">
                                    <input disabled name="name" id="txt-ma-sp" type="text" class="span6 m-wrap"
                                           style="width:500px !important;" value="${sanPham.maSP}"/>
                                    <br>
                                    <small class="text-danger" id="validate-txt-ma-sp"></small>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Tên sản phẩm<span class="required">*</span></label>
                                <div class="controls">
                                    <input disabled id="txt-ten-sp" name="name" type="text" class="span6 m-wrap"
                                           style="width:500px !important;" value="${sanPham.tenSP}"/>
                                    <br>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input disabled id="txt-gia-sp" name="name" type="text" class="span6 m-wrap"
                                           style="width:500px !important;" value="${sanPham.giaSP}"/>
                                    <br>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input disabled id="txt-khuyen-mai" name="name" type="text" class="span6 m-wrap"
                                           style="width:500px !important;" value="${sanPham.phanTramKhuyenMai}"/>
                                    <br>
                            ...
                            <%--<div class="control-group">--%>
                                ...
                                <%--<div class="controls">--%>
                                    <%--<div class="uploader" id="uniform-fileInput">--%>
                                        <%--<input disabled class="input-file uniform_on" id="fileInput" type="file"><span--%>
                                            <%--class="filename"--%>
                                            <%--style="user-select: none;;">WebHaiSan\Admin\bootstrap\img</span><span--%>
                                            <%--class="action"--%>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input disabled id="txt-xuat-xu" name="name" type="text" class="span6 m-wrap"
                                           style="width:500px !important;" value="${sanPham.xuatXu}"/>
                                    <br>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea disabled id="txt-mo-ta" name="name" type="text" class="span6 m-wrap"
                                              style="width:500px !important;">${sanPham.moTa}</textarea>
                                    <br>
                                    <small class="text-danger" id="validate-txt-mo-ta"></small>
                                </div>
                            </div>
                            <div style="text-align:center;">
                                <a href="/Admin/QLSanPham?idDM=${sanPham.maDanhMuc}&page=1" type="button"
                                   class="btn btn-success btn-large">Quay về trang chủ</a>
                            </div>
                        </form>
