...
<%
    Map<String, Integer> mapDT = ThongKeService.getInstance().getDonHang();
    ...
    <script type="text/javascript">
        window.onload = function() {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                axisX: {
                    title: "Biểu đồ thể hiện lượng đơn đặt hàng trong năm nay"
                },
                axisY: {
                    title: ""
                },
        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse collapse">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a href="/DBSM_war_exploded/Admin/QlyBaiViet?page=1">Quản lý Bài Viết</a>
                    </li>
                    <li>
        ...
        <div class="row-fluid">
            ...
            <div class="block">
                <div class="navbar navbar-inner block-header" style="text-align:center">
                    <div class="muted pull-left">Thống kê đơn hàng</div>
                </div>
